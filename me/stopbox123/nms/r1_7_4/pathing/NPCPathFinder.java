package me.stopbox123.nms.r1_7_4.pathing;
...
public class NPCPathFinder extends Thread {
	...
	private void scoreBlock(Node node, Node parent) {
		final int diagonal = node.xPos != parent.xPos
				&& node.zPos != parent.zPos || node.xPos != parent.xPos
				&& node.yPos != parent.yPos || node.yPos != parent.yPos
				&& node.zPos != parent.zPos ? 14 : 10;
